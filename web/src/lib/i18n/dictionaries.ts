...
export const en = {
  ...
  "work.missing": "This work's folder is gone from disk ({folder}). It stays hidden from the library until a scan finds it again.",
  ...
  "work.clearProgress": "Clear progress",
  "work.clearProgressTitle": "Clear play progress?",
  "work.clearProgressBefore": "Forgets how far you got into every track of ",
  "work.clearProgressAfter":
    ", and takes it off the On deck row. Likes and bookmarks are kept.",
  "work.clearProgressConfirm": "Clear",
  "work.clearProgressPending": "Clearing…",
  "work.clearProgressDone": "Play progress cleared",
  "work.clearProgressFailed": "Couldn’t clear progress: {error}",
  "work.extras": "Extras",
  ...
  "settings.missing.title": "{count} works are missing from disk",
  "settings.missing.title_one": "1 work is missing from disk",
  "settings.missing.body":
    "A scan could not find these works' folders, so they are hidden from the library. Nothing has been deleted. If a drive was disconnected, reconnect it and scan again — they will come back with their likes and playback progress intact.",
  "settings.missing.remove": "Remove {count} works",
  "settings.missing.remove_one": "Remove 1 work",
  "settings.missing.removed": "Removed {count} works",
  "settings.missing.removed_one": "Removed 1 work",
  "settings.missing.keepHint": "Removes library entries only — never your files.",
  ...
  "scan.status.rootsUnverified": "Library root unreadable — nothing changed",
  "scan.log.rootsUnverified":
    "  ! Could not read {roots}. Skipped the missing-work check so a disconnected drive cannot empty the library.",
  "scan.log.missingReconciled": "  • {marked} works now missing, {restored} back",
...
export const ja: Record<TranslationKey, string> = {
  ...
  "work.missing": "この作品のフォルダーが見つかりません（{folder}）。再スキャンで見つかるまでライブラリには表示されません。",
  ...
  "work.clearProgress": "再生位置を消去",
  "work.clearProgressTitle": "再生位置を消去しますか？",
  "work.clearProgressBefore": "「",
  "work.clearProgressAfter":
    "」のすべてのトラックの再生位置を消去し、「続きから」から外します。お気に入りとブックマークは残ります。",
  "work.clearProgressConfirm": "消去",
  "work.clearProgressPending": "消去中…",
  "work.clearProgressDone": "再生位置を消去しました",
  "work.clearProgressFailed": "再生位置を消去できませんでした：{error}",
  "work.extras": "おまけ",
  ...
  "settings.missing.title": "{count}件の作品がディスク上に見つかりません",
  "settings.missing.title_one": "1件の作品がディスク上に見つかりません",
  "settings.missing.body":
    "スキャンでこれらの作品のフォルダーが見つからなかったため、ライブラリから非表示にしています。まだ何も削除していません。ドライブを取り外していた場合は、接続してから再スキャンすると、お気に入りや再生位置もそのまま元に戻ります。",
  "settings.missing.remove": "{count}件を削除",
  "settings.missing.remove_one": "1件を削除",
  "settings.missing.removed": "{count}件を削除しました",
  "settings.missing.removed_one": "1件を削除しました",
  "settings.missing.keepHint": "削除されるのはライブラリの項目だけで、ファイルは残ります。",
  ...
  "scan.status.rootsUnverified": "ライブラリルートを読み取れません。変更なし",
  "scan.log.rootsUnverified":
    "  ! {roots} を読み取れませんでした。ドライブ未接続でライブラリが空にならないよう、不明作品の判定を省略しました。",
  "scan.log.missingReconciled": "  • 見つからない作品 {marked}件、復帰 {restored}件",
